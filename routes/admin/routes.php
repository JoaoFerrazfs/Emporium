...
Route::middleware(['auth','adminUser'])->prefix('admin')->group(function () {
    ...
    Route::get('/pedidos',[OrderController::class,'index'])->name('admin.orders');
    Route::get('/pedido/{id}',[OrderController::class,'showOrderDetail'])->name('admin.show.order');
    ...
    Route::get('/produtos/deletarProdutos/{id}',[ProductController::class,'deleteProducts'])->name('admin.products.delete');
